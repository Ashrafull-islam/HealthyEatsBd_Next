  ...
  <section>
    ...
    >
      <div className="hero-content">
        <h1 className="banner-header">Privacy Policy</h1>
  ...
  <section>
    <div className="text-container p-3 my-5">
      <div className="text-content">
        <h6 className="normal-text">Last updated: February 17, 2022</h6>
        ...
        <p className="bold-text">
          Interpretation and Definitions <br /> Interpretation
        </p>
        <p className="normal-text">
        ...
        <p className="normal-text">
          ...
          or parts of our Service. <br /> Company (referred to as either “the
          Company”, “We”, “Us” or “Our” in this Agreement) refers to Healthy
          Eats. <br /> Cookies are small files that are placed on Your computer,
          mobile device or any other device by a website, containing the details
          of Your browsing history on that
        </p>
        <p className="normal-text">website among its many uses.</p>
        <p className="normal-text">
          Country refers to: Bangladesh <br /> Device means any device that can
        ...
        <p className="normal-text">
          ...
          <br />
          Website refers to Healthy Eats , accessible from
          https://healhtyeatsbd.com/
          <br />
        ...
        <p className="normal-text">
          ...
          to, the type of mobile device You use, Your
        </p>
        <p className="normal-text">
        ...
        <p className="normal-text">
          ...
          If You choose to provide such information
        </p>
        <p className="normal-text">
          and Personal Data, during registration or otherwise, You are giving
          the Company permission to use, share, and store it in a manner
          consistent with this Privacy Policy.
        </p>
        <p className="bold-text">Tracking Technologies and Cookies</p>
        <p className="normal-text">
        ...
        <p className="normal-text">
          ...
          as clear gifs, pixel tags, and single-pixel gifs)
        </p>
        <p className="normal-text">
        ...
        <p className="normal-text">
          a certain section and verifying system and server integrity). <br />
          Cookies can be “Persistent” or “Session” Cookies. Persistent Cookies
          remain on Your personal computer or mobile device when You go offline,
          while Session Cookies are deleted as
        </p>
        <p className="normal-text">
          soon as You close Your web browser. You can learn more about cookies
        ...
        <p className="normal-text">
          ...
          You having to re-enter your preferences every
        </p>
        <p className="normal-text">
          time You use the Website. <br />
          For more information about the cookies we use and your choices
          regarding cookies, please visit our Cookies Policy or the Cookies
          section of our Privacy Policy.
        </p>
        <p className="bold-text">Use of Your Personal Data</p>
        <p className="normal-text">
        ...
        <p className="normal-text">
          to evaluate and improve our Service, products, services, marketing and
          your experience. <br />
        ...
        <p className="normal-text">
          of all or a portion of Our business to another company. <br />
        ...
        <p className="normal-text">
          ...
          We control or that are under common control with Us. <br />
        ...
        <p className="bold-text">Retention of Your Personal Data</p>
        <p className="normal-text">
        ...
        <p className="bold-text">Transfer of Your Personal Data</p>
        <p className="normal-text">
        ...
        <p className="bold-text">Disclosure of Your Personal Data</p>
        <p className="normal-text">
        ...
        <p className="bold-text">Law enforcement</p>
        <p className="normal-text">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <p className="bold-text">Other legal requirements</p>
        <p className="normal-text">
          The Company may disclose Your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <p className="bold-text">Comply with a legal obligation</p>
        <p className="normal-text">
        ...
        <p className="bold-text">Security of Your Personal Data</p>
        <p className="normal-text">
        ...
        <p className="bold-text">Links to Other Websites</p>
        <p className="normal-text">
        ...
        <p className="normal-text">Changes to this Privacy Policy</p>
        <p className="normal-text">
        ...
        <p className="normal-text">
          ...
          us: Email:&nbsp;info@healthyeatsbd.com&nbsp;or over the phone call to
          Phone: +88 01581-044495 during office hour
        </p>
      </div>
    </div>
  </section>
