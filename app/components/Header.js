      ...
      <header>
        ...
        <section className="top-bar">
          <div className="container">
            <p className="top-bar-text text-center text-white mb-0">Shipping All Over Bangladesh!! The Pure Taste Of
              Nature.</p>
          </div>
        </section>
        {/* Topbar End */}
        ...
        <section>
          <div className="main-navbar" id="header">
                    ...
                    <div className="d-flex justify-content-between align-content-center">
                      <div className="main-logo">
                        <Link href="/index.html">
                          <Image src="/media/logo.png" alt="Main Logo" loading="lazy" decoding="async" width={150}
                            height={50} className="fixed-img" />
                        </Link>
                      </div>
                  ...
                  <div className="nav-right">
                    <form className="search-bar me-3">
                      <div className="form-floating position-relative">
                        ...
                        <button className="btn p-0 pe-3 position-absolute top-50 end-0 translate-middle-y">
                    ...
                    <div className="user">
                      <a className="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#userAuthOffcanvas" aria-controls="userAuthOffcanvas">
                    ...
                    <div className="cart">
                      <a href="#" className="position-relative btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#cartOffCanvas" aria-controls="cartOffCanvas">
                        <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="position-absolute top-0 start-70 translate-middle badge rounded-pill bg-unread">0
              ...
              <div className="mobile-menu py-2">
                <div className="d-flex justify-content-between align-items-center">
                  <div className="mobile-menu-icon">
                    <button className="d-flex align-items-center p-0 btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileMenuOffcanvas" aria-controls="mobileMenuOffcanvas">
                  ...
                  <div className="main-logo">
                    <Link href="/index.html">
                      <Image src="/media/logo.png" alt="Main Logo" loading="lazy" width={150}  // Set a width
                        height={50} decoding="async" className="fixed-img small-logo" />
                    </Link>
                  </div>
                  <div className="cart">
                    <a href="#" className="position-relative btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#cartOffCanvas" aria-controls="cartOffCanvas">
            ...
            {/* Mobile Menu */}
            <div className="offcanvas offcanvas-start" tabIndex={-1} id="mobileMenuOffcanvas" aria-labelledby="mobileMenuOffcanvasLabel">
              <div className="offcanvas-header d-flex justify-content-end">
                <button type="button" className="btn p-0 d-flex align-items-center" data-bs-dismiss="offcanvas" aria-label="Close">
                ...
                <div className="container-fluid p-0">
                  <div className="p-3-bottom">
                    <div className="search-container">
                      <input type="search" className="form-control" id="searchInput" placeholder="Search for products" />
                    </div>
                  </div>
                  <ul className="nav nav-tabs" id="menuTabs" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link active" id="menu-tab" data-bs-toggle="tab" data-bs-target="#menu" type="button" role="tab">MENU</button>
                    </li>
                    <li className="nav-item" role="presentation">
                  ...
                  <div className="tab-content" id="menuTabsContent">
                    <div className="tab-pane fade show active" id="menu" role="tabpanel">
                      <ul className="menu-list">
                        <li><Link href="/">HOME</Link></li>
                        <li><Link href="store">STORE</Link></li>
                        <li>
                          <Link href="/arrivals" className="d-flex justify-content-between align-items-center">
                            NEW ARRIVALS
                    ...
                    <div className="tab-pane fade" id="categories" role="tabpanel">
                      <div>
                        <ul className="menu-list">
                          <li><Link href="#">NATURAL SWEETENERS</Link></li>
                          <li><Link href="#">PICKLES</Link></li>
                          <li><Link href="#">KITCHEN ESSENTIALS</Link></li>
                          <li><Link href="#">SPECIAL PRODUCTS</Link></li>
                          <li><Link href="#">NUTS&amp;SEEDS</Link></li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <div className="offcanvas offcanvas-end" tabIndex={-1} id="cartOffCanvas" aria-labelledby="cartOffCanvasLabel">
              ...
              <div className="offcanvas-body">
                <div className="empty-cart-content">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width={150} height={150} fill="lightgray" className="bi bi-cart-x" viewBox="0 0 16 16">
                    <path d="M7.354 5.646a.5.5 0 1 0-.708.708L7.793 7.5 6.646 8.646a.5.5 0 1 0 .708.708L8.5 8.207l1.146 1.147a.5.5 0 0 0 .708-.708L9.207 7.5l1.147-1.146a.5.5 0 0 0-.708-.708L8.5 6.793z" />
                    <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zm3.915 10L3.102 4h10.796l-1.313 7zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0" />
                  </svg>
                  <p className="empty-message my-3 fs-6 fw-bold">No products in the cart.</p>
            ...
            <div className="offcanvas offcanvas-end p-10" tabIndex={-1} id="userAuthOffcanvas" aria-labelledby="userAuthOffcanvasLabel">
              <div className="offcanvas-header d-flex justify-content-between align-content-center border border-bottom-success">
                ...
                <button type="button" className="btn d-flex align-items-center" data-bs-dismiss="offcanvas" aria-label="Close">
                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
                    <path fill="currentColor" d="M6.4 19L5 17.6l5.6-5.6L5 6.4L6.4 5l5.6 5.6L17.6 5L19 6.4L13.4 12l5.6 5.6l-1.4 1.4l-5.6-5.6z" />
                  </svg>
                  Close</button>
              ...
              <div className="offcanvas-body p-0 m-0">
                <div className="login-container p-3">
                  <form>
                    <div className="mb-3">
                      <label htmlFor="username" className="form-label required">Username or email address</label>
                    ...
                    <button type="submit" className="btn btn-login text-white">LOG IN</button>
                    ...
                    <div className="avatar-section my-3">
                      <div className="avatar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width={66} height={66} fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
                          <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                        </svg>
                      </div>
                      <p className="no-account">No account yet?</p>
                      <a href="#" className="create-account border-bottom border-success d-inline-block">CREATE AN
                        ACCOUNT</a>
                    </div>
                  </form>
                </div>
            ...
            <div className="bottom-nav">
              <div className="container h-100">
                <div className="row h-100 align-items-center justify-content-around g-0">
                  <Link href="/index.html" className="col nav-item active">
                  ...
                  <Link href="/store.html" className="col nav-item" type="button" data-bs-toggle="offcanvas" data-bs-target="#cartOffCanvas" aria-controls="cartOffCanvas">
                    <svg viewBox="0 0 24 24">
                  ...
                  <Link href="/wishlist.html" className="col nav-item">
                    <svg viewBox="0 0 24 24">
                      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                    </svg>
                    Wishlist
                  </Link>
                  <Link href="/login.html" className="col nav-item">
                    <svg viewBox="0 0 24 24">
