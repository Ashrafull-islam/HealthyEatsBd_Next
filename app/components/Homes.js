...
export default function Home() {
  return (
    <main>
        ...
        <div className="slider-section">
          <div className="swiper custom-swiper">
            <div className="swiper-wrapper">
              <Swiper pagination={true} modules={[Pagination, Autoplay]} loop={true} className="mySwiper" autoplay={{
                delay: 3000,
      ...
      <section>
        <div className="home-product-card-section">
          <div className="loved-product text-center">
            <img src="assets/media/home/banner-section/loved-product.png" className="img-fluid" alt="lovedImage" decoding="async" loading="lazy" />
          </div>
          ...
          <div className="swiper-card">
            ...
            >
                ...
                <div className="swiper-slide">
                  <div className="card text-center position-relative">
                    <div className="card-img">
                      <img src="assets/media/home/card-section/card1.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
                    </div>
                    <div className="new-badge">-8%</div>
                    <h4 className="chocolate-p my-1 p-0">Chocolate Peanut Butter-
                      চকলেট পিনাট বাটার</h4>
                    ...
                    <div className="hover-icon position-absolute d-flex flex-column">
                      <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fillRule="currentColor" className="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0" />
                      </svg>
                      <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fillRule="currentColor" className="bi bi-heart my-3" viewBox="0 0 16 16">
              ...
              <SwiperSlide>
                <div className="swiper-slide">
                  <div className="card text-center position-relative">
                    <div className="card-img">
                      <img src="assets/media/home/card-section/card2.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
                    </div>
                    <div className="new-badge">-11%</div>
                    <h4 className="chocolate-p my-1 p-0">Bilona Ghee – বিলোনা ঘি</h4>
                    <p className="price text-center mb-2 p-0">৳&nbsp;800 - ৳&nbsp;1,550 </p>
                    <div>
                      <button className="card-btn card-btn-completed" />
                    </div>
                    <div className="hover-icon position-absolute d-flex flex-column">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="currentColor" className="bi bi-heart my-3" viewBox="0 0 16 16">
                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15" />
                      </svg>
                    </div>
                  </div>
              ...
              <SwiperSlide>
                <div className="swiper-slide">
                  <div className="card text-center position-relative">
                    <div className="card-img">
                      <img src="assets/media/home/card-section/card3.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
                    </div>
                    <div className="persent-badge">New</div>
                    <h4 className="chocolate-p my-1 p-0">Sugarcane Jaggery Powder –
                      আখের গুড় পাউডার</h4>
              ...
              <SwiperSlide>
                <div className="swiper-slide">
                  <div className="card text-center position-relative">
                    <div className="card-img">
                      <img src="assets/media/home/card-section/card4.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
                    </div>
                    <div className="new-badge">-14%</div>
                    <h4 className="chocolate-p my-1 p-0">Patali Khejur Gur – পাটালি
                      খেজুরের গুড়</h4>
                    <p className="price text-center mb-2 p-0">৳&nbsp;700 - ৳&nbsp;1,800 </p>
                    <div>
                      <button className="card-btn card-btn-completed" />
                    </div>
                    <div className="hover-icon position-absolute d-flex flex-column">
              ...
              <SwiperSlide>
                <div className="swiper-slide">
                  <div className="card text-center position-relative">
                    <div className="card-img">
                      <img src="assets/media/home/card-section/card5.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
                    </div>
                    <div className="persent-badge">New</div>
                    <h4 className="chocolate-p my-1 p-0">Moringa Powder – মারিঙ্গা
                      পাউডার</h4>
                    <p className="price text-center mb-2 p-0">৳&nbsp;700 - ৳&nbsp;1,350 </p>
                    <div>
                      <button className="card-btn card-btn-completed" />
                    </div>
                    <div className="hover-icon position-absolute d-flex flex-column">
            ...
            <div className="text-center btn-box d-flex align-content-center">
              <Link href="/store" className="see-btn">
                SEE ALL
                <svg
          ...
          <div className="medium-card-container">
            ...
            <div className="card text-center position-relative">
              <div className="card-img">
                <img src="assets/media/home/card-section/card6.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
              </div>
              <div className="new-badge">-18%</div>
              <h4 className="chocolate-p my-1 p-0">Premium Tea – প্রিমিয়াম চা</h4>
              <p className="price text-center mb-2 p-0">৳&nbsp;400 - ৳&nbsp;800 </p>
              <div>
                <button className="card-btn card-btn-completed" />
              </div>
              <div className="hover-icon position-absolute d-flex flex-column">
            ...
            <div className="card text-center position-relative">
              <div className="card-img">
                <img src="assets/media/home/card-section/card7.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
              </div>
              <div className="persent-badge">New</div>
              <h4 className="chocolate-p my-1 p-0">Mustard Oil – ঘানি ভাঁঙ্গা সরিষার তেল</h4>
              <p className="price text-center mb-2 p-0">৳&nbsp;290 - ৳&nbsp;1350 </p>
              <div>
                <button className="card-btn card-btn-completed" />
              </div>
              <div className="hover-icon position-absolute d-flex flex-column">
            ...
            <div className="card text-center position-relative">
              <div className="card-img">
                <img src="assets/media/home/card-section/card8.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
              </div>
              <div className="new-badge">-11%</div>
              <h4 className="chocolate-p my-1 p-0">Black Rice – কালো চাল</h4>
              <p className="price text-center mb-2 p-0">৳&nbsp;200 - ৳&nbsp;520 </p>
              <div>
                <button className="card-btn card-btn-completed" />
              </div>
              <div className="hover-icon position-absolute d-flex flex-column">
            ...
            <div className="card text-center position-relative">
              <div className="card-img">
                <img src="assets/media/home/card-section/card9.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
              </div>
              <div className="new-badge">-11%</div>
            ...
            <div className="card text-center position-relative">
              <div className="card-img">
                <img src="assets/media/home/card-section/black-rice.png" alt="cardimage" decoding="async" loading="lazy" className='img-flaut' />
              </div>
              <div className="persent-badge">New</div>
          ...
          <div className="pinat-container">
            <div className="row align-items-center g-md-5">
              <div className="pinat-img col-12 col-md-5 p-md-5">
                <Image src="/media/home/butter-section/pinatbannar-banner.png" height={500} width={500} className="img-fluid" alt="pinatImage" loading="lazy" decoding="async" />
              </div>
              <div className="pinat-text col-12 col-md-7 p-md-5">
                <h2 className="pinat-head">‘’প্রোটিনে ভরপুর পিনাট বাটার <br /> সারাদিনের শক্তির আধার ‘’</h2>
                <div className="d-flex align-items-center gap-2">
                  <div className="rating">
                    <input type="radio" id="star5" name="rating" defaultValue={5} /><label htmlFor="star5">★</label>
                    <input type="radio" id="star4" name="rating" defaultValue={4} /><label htmlFor="star4">★</label>
                    <input type="radio" id="star3" name="rating" defaultValue={3} /><label htmlFor="star3">★</label>
                    <input type="radio" id="star2" name="rating" defaultValue={2} /><label htmlFor="star2">★</label>
                    <input type="radio" id="star1" name="rating" defaultValue={1} /><label htmlFor="star1">★</label>
                  </div>
                  <p className="rating-review m-0 p-0">208 reviews</p>
                </div>
                <p className="upokarita text-start text-ld-center">চিনাবাদাম ও বাছাইকৃত সেরা লিচু ফুলের মধুর
                  সংমিশ্রণে তৈরি একটু বেশিই
                  হেলদি এই পিনাটবাটার থাকুক আপনার নাস্তার টেবিলে।</p>
                <div className="pinat-batter-text d-flex align-items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 24 24" fill="none">
                    <rect width={22} height={22} rx={4} fill="#276B41" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M7.5 11.5L10.5 14.5L16.5 8.5" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <p className="m-0 p-0 improve-text">রোগ প্রতিরোধ ক্ষমতা বৃদ্ধি করে</p>
                </div>
                <div className="pinat-batter-text d-flex align-items-center gap-3 my-1">
                  ...
                  <p className="m-0 p-0 improve-text">ব্রেইনকে করবে আরো বেশি শার্পার</p>
                </div>
                <div className="pinat-batter-text d-flex align-items-center gap-3 my-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 24 24" fill="none">
                    <rect width={22} height={22} rx={4} fill="#276B41" />
                  ...
                  <p className="m-0 p-0 improve-text">পিনাট বাটারে থাকা স্বাস্থ্যকর চর্বি ও প্রোটিন দীর্ঘক্ষণ
                    শক্তি জোগায়
                  </p>
                </div>
                <div className="pinat-batter-text d-flex align-items-center gap-3">
                  ...
                  <p className="m-0 p-0 improve-text">রয়েছে প্রচুর পরিমাণে প্রোটিন যা পেশী গঠনে ভূমিকা রাখে
                  </p>
                </div>
                <button className="order-btn my-3">অর্ডার করুন</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="healthry-banner" style={{ backgroundImage: `url(${encodeURI('assets/media/home/banner-section/home-banner-image.png')})` }}>
          <div className="banner-text d-flex flex-column flex-md-row text-center">
            <p className="text-one">WE ARE <br />HEALTHY <br />EATS</p>
            <p className="text-two">We collect pure and fresh <br />groceries directly from <br />core farmers and serve
              <br />you
              to your doorstep.
            </p>
            <div className="small-chachi d-block d-md-none ">
              <Image src="/media/home/banner-section/small-banner.png" height={150} width={150} alt="ChachiImage" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="ghee-section">
          <div className="ghee-container">
            <div className="row align-content-center">
              <div className="ghee-img col-12 col-md-5">
                <Image src="/media/home/ghee-section/ghee.png" className="img-fluid" alt="gheeImage" height={400} width={400} loading="lazy" decoding="async" />
              </div>
      ...
      <section>
        <div className="banner-section" style={{ backgroundImage: `url(${encodeURI("assets/media/home/banner-section/home-ghee-banner.jpg")})` }}>
        </div>
      </section>
        ...
        <div className="client-review-section">
          ...
          <div className="review-swiper-container">
            <div className="swiper">
              <div className="swiper-wrapper">
                <Swiper navigation={true} loop={true} modules={[Navigation, Autoplay]} autoplay={{
                  delay: 3000,
                  disableOnInteraction: false,
                }} className="mySwiper">
                  <SwiperSlide>
                    <div className="review-card">
                      <p className="review-text">নামি দামি অনেক পেইজ থেকে ঘি নিয়েও কথায় আর ঘি এর
                        স্বাদের কোনো মিল পাই নি।হেলদি ইটস থেকে ঘি নিয়ে বুঝতেই
                        পারি নি যে এই ঘি এত টা সুঘ্রাণ আর স্বাদে অতুলণীয়।ধন্যবাদ
                        হেলদি ইটসকে এত চমৎকার কার একটি পণ্য আমাদের দার
                        প্রান্তে পৌছে দেয়ার জন্য।</p>
                      <div className="d-flex">
                        <svg xmlns="http:www.w3.org/2000/svg" width={43} height={55} viewBox="0 0 43 55" fill="none">
                          <mask id="mask0_187_1329" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x={0} y={0} width={43} height={55}>
                            <path d="M43 0H0V55H43V0Z" fill="white" />
                          </mask>
                          <g mask="url(#mask0_187_1329)">
                            <mask id="mask1_187_1329" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x={0} y={5} width={37} height={39}>
                              <path d="M36.7735 5.89331H0V43.667H36.7735V5.89331Z" fill="white" />
                            </mask>
                            <g mask="url(#mask1_187_1329)">
                              <path d="M35.6232 24.5296C34.3937 23.4887 32.4503 23.3995 31.1748 24.8056L28.0082 28.2972C27.5989 26.9457 26.3701 25.9616 24.9215 25.9616H19.2709C18.842 25.9616 18.6985 25.7934 17.9536 25.204C15.1139 22.6611 10.8486 22.6692 8.0175 25.2283L5.9405 27.1066C5.00687 26.5989 3.91667 26.5864 2.97794 27.0682L0.595703 28.2913C0.0634922 28.565 -0.151905 29.2297 0.113768 29.7764L6.57751 43.0554C6.84395 43.6021 7.49103 43.8233 8.02325 43.5504L10.4055 42.3265C11.5797 41.7239 12.2332 40.4933 12.1908 39.2407H24.9215C27.2821 39.2407 29.538 38.0824 30.9543 36.1423L36.126 29.0587C37.1293 27.6857 36.9706 25.6724 35.6232 24.5296ZM9.44157 40.3472L8.02318 41.076L2.52258 29.7764L3.94173 29.0475C4.47395 28.7746 5.12028 28.9952 5.38674 29.5425L9.92357 38.863C10.1893 39.4096 9.97378 40.0734 9.44157 40.3472ZM34.4023 27.7307L29.2307 34.8143C28.2187 36.2005 26.6078 37.0274 24.9215 37.0274H11.4389L7.40197 28.7332L9.4409 26.8897C11.4697 25.0564 14.5293 25.0564 16.5581 26.8897C17.7532 27.9705 18.4965 28.1748 19.2707 28.1748H24.9215C25.5154 28.1748 25.9987 28.6713 25.9987 29.2814C25.9987 29.8914 25.5153 30.388 24.9215 30.388H19.4194C18.8248 30.388 18.3422 30.8838 18.3422 31.4946C18.3422 32.1054 18.8248 32.6011 19.4194 32.6011H25.6433C26.5374 32.6011 27.3993 32.216 28.0082 31.544L32.7512 26.3143C33.185 25.8362 33.85 25.876 34.258 26.2427C34.6845 26.6263 34.7306 27.2821 34.4023 27.7307Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                              <path d="M22.6514 13.4456C23.389 12.6511 23.8436 11.577 23.8436 10.3944C23.8436 7.95842 21.9275 5.89429 19.5345 5.89429C17.1595 5.89429 15.1536 7.95472 15.1536 10.3944C15.1536 11.5408 15.591 12.623 16.3853 13.4545C14.4153 14.5891 12.999 16.7668 12.999 19.3209V20.4274C12.999 21.0382 13.4817 21.534 14.0763 21.534H24.921C25.5156 21.534 25.9983 21.0382 25.9983 20.4274V19.3209C25.9982 16.817 24.6575 14.6053 22.6514 13.4456ZM19.5345 8.10752C20.7023 8.10752 21.6891 9.15508 21.6891 10.3945C21.6891 11.6146 20.7224 12.6076 19.5345 12.6076C18.3279 12.6076 17.3082 11.594 17.3082 10.3945C17.3082 9.17647 18.3488 8.10752 19.5345 8.10752ZM15.1536 19.3209C15.1536 16.8812 17.1595 14.8208 19.5345 14.8208C21.9103 14.8208 23.8436 16.8391 23.8436 19.3209H15.1536Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                            </g>
                          </g>
                        </svg>
                        <div className="ms-1">
                  ...
                  <SwiperSlide>
                    <div className="review-card">
                      <p className="review-text">আপনাদের ঘি এর প্যাকেজিং অনেক ভালো লেগেছে।
                        কাচেরজার এ পরিবেশন সত্যিই ইউনিক ছিল।</p>
                      <div className="d-flex">
                        <svg xmlns="http:www.w3.org/2000/svg" width={43} height={55} viewBox="0 0 43 55" fill="none">
                          <mask id="mask0_187_1329" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x={0} y={0} width={43} height={55}>
                            <path d="M43 0H0V55H43V0Z" fill="white" />
        ...
        <div className="blog-section">
          ...
          <div className="blog-container my-5">
            <div className="card-box">
              <img src="assets/media/home/blog-section/blogcard1.png" alt="cardImage" className="img-fluid" loading="lazy" decoding="async" />
              <div className="card-text p-3">
                <p className="card-date">04 Sep 2024</p>
                <h3 className="mousumi-achar">বেলোনা ঘি এর বৈশিষ্ট্য</h3>
                <p className="card-texts">আপনি কি জানেন যে আপনি যে ঘি গ্রহণ করেন তার গুণমান তার পুষ্টিগুণ এবং
                  স্বাস্থ্য উপকারিতাকে ব্যাপকভাবে সংজ্ঞায়িত করে? গুণমান নিশ্চিত করতে...</p>
                <h4>CONTINUE READING</h4>
              </div>
            </div>
            <div className="card-box">
              <img src="assets/media/home/blog-section/blogcard2.png" alt="cardImage" className="img-fluid" loading="lazy" decoding="async" />
              <div className="card-text p-3">
                <p className="card-date">04 Sep 2024</p>
            ...
            <div className="card-box">
              <img src="assets/media/home/blog-section/blogcard3.png" alt="cardImage" className="img-fluid" loading="lazy" decoding="async" />
              <div className="card-text p-3">
                <p className="card-date">29 Dec 2023</p>
                <h3 className="mousumi-achar">প্রাকৃতিক মিষ্টান্ন এর কার্যকারিতা</h3>
                <p className="card-texts">গুড় হলো আখ বা খেজুর গাছ বা খেজুরের ঘন রস থেকে প্রাপ্ত একটি প্রাকৃতিক
                  মিষ্টান্ন। একটি ঐতিহ্যগত প্রক্রিয়ার মাধ্যমে…</p>
                <h4>CONTINUE READING</h4>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-6 col-md-3 service-card mb-4 mb-md-0">
              ...
              <div className="service">
                <p className="service-first m-0 p-0">Customer Service</p>
                <p className="service-second m-0 p-0 text-center text-md-start">Top notch customer service.</p>
              </div>
            </div>
            <div className="col-6 col-md-3 service-card mb-4 mb-md-0">
              <svg xmlns="http://www.w3.org/2000/svg" className="service-icon" viewBox="0 0 55 55" fill="none">
              ...
              <div className="service">
                <p className="service-first m-0 p-0">Pickop At Any Store</p>
                <p className="service-second m-0 p-0 text-center text-md-start">Order anywhere</p>
              </div>
            </div>
            <div className="col-6 col-md-3 service-card">
              <svg xmlns="http://www.w3.org/2000/svg" className="service-icon" viewBox="0 0 55 55" fill="none">
                ...
                <g clipPath="url(#clip0_0_1)">
                  <g clipPath="url(#clip1_0_1)">
                    <path d="M53.2812 34.375C52.3325 34.375 51.5625 35.145 51.5625 36.0938V48.125H3.4375V27.5H22.3438C23.2925 27.5 24.0625 26.73 24.0625 25.7812C24.0625 24.8325 23.2925 24.0625 22.3438 24.0625H3.4375V17.1875H22.3438C23.2925 17.1875 24.0625 16.4175 24.0625 15.4688C24.0625 14.52 23.2925 13.75 22.3438 13.75H3.4375C1.54 13.75 0 15.29 0 17.1875V48.125C0 50.0225 1.54 51.5625 3.4375 51.5625H51.5625C53.46 51.5625 55 50.0225 55 48.125V36.0938C55 35.145 54.23 34.375 53.2812 34.375Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                    <path d="M15.4688 34.375H8.59375C7.645 34.375 6.875 35.145 6.875 36.0938C6.875 37.0425 7.645 37.8125 8.59375 37.8125H15.4688C16.4175 37.8125 17.1875 37.0425 17.1875 36.0938C17.1875 35.145 16.4175 34.375 15.4688 34.375Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                    <path d="M53.9584 8.73039L41.9272 3.57414C41.4906 3.39195 41.0059 3.39195 40.5694 3.57414L28.5381 8.73039C27.9091 9.00195 27.5 9.62414 27.5 10.3116V17.1866C27.5 26.6432 30.9959 32.1707 40.3941 37.5848C40.6588 37.736 40.9544 37.8116 41.25 37.8116C41.5456 37.8116 41.8412 37.736 42.1059 37.5848C51.5041 32.1845 55 26.657 55 17.1866V10.3116C55 9.62414 54.5909 9.00195 53.9584 8.73039ZM51.5625 17.1866C51.5625 25.1238 48.9363 29.4929 41.25 34.0991C33.5637 29.4826 30.9375 25.1135 30.9375 17.1866V11.446L41.25 7.02539L51.5625 11.446V17.1866Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                    <path d="M47.482 14.1245C46.7429 13.5401 45.6635 13.6535 45.0654 14.3926L39.6617 21.1507L37.5235 17.9538C36.9907 17.1632 35.9217 16.9535 35.1413 17.476C34.3542 18.002 34.1376 19.071 34.6635 19.8582L38.101 25.0145C38.407 25.4717 38.9088 25.7535 39.4588 25.781C39.4829 25.781 39.5104 25.781 39.531 25.781C40.0501 25.781 40.5451 25.5473 40.8751 25.1348L47.7501 16.541C48.3413 15.7985 48.2245 14.7192 47.482 14.1245Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                  </g>
                </g>
                <defs>
              ...
              <div className="service">
                <p className="service-first m-0 p-0">Secured Payment</p>
                <p className="service-second m-0 p-0 text-center text-md-start">All major credit cards.</p>
              </div>
            </div>
            <div className="col-6 col-md-3 service-card">
              <svg xmlns="http://www.w3.org/2000/svg" className="service-icon" viewBox="0 0 55 55" fill="none">
                ...
                <g clipPath="url(#clip0_0_1)">
                  <g clipPath="url(#clip1_0_1)">
                    <path d="M27.5004 8.70117C24.2085 8.70117 21.5301 11.3794 21.5301 14.6714V17.6371H16.1017L14.7715 42.0833H40.2291L38.899 17.6371H33.4705V14.6714C33.4707 11.3794 30.7925 8.70117 27.5004 8.70117ZM36.8266 38.8607H18.1744L19.1539 20.8598H35.8471L36.8266 38.8607ZM27.5004 11.9238C29.0155 11.9238 30.248 13.1564 30.248 14.6714V17.6371H24.7528V14.6714C24.7529 13.1564 25.9855 11.9238 27.5004 11.9238Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                    <path d="M50.7345 12.791L54.4264 13.4384L54.9828 10.2642L45.7098 8.63844L44.0841 17.9115L47.2583 18.4681L47.9646 14.4396C50.437 18.3188 51.7773 22.8665 51.7773 27.5C51.7773 33.9847 49.2521 40.0812 44.6667 44.6667C40.0814 49.2521 33.9848 51.7773 27.5 51.7773C21.0152 51.7773 14.9187 49.2521 10.3333 44.6667C5.74793 40.0814 3.22266 33.9847 3.22266 27.5C3.22266 21.0153 5.74793 14.9187 10.3333 10.3333C14.9187 5.74804 21.0153 3.22266 27.5 3.22266C32.182 3.22266 36.7261 4.55759 40.6413 7.08318L42.3882 4.37508C37.9513 1.51293 32.803 0 27.5 0C20.1545 0 13.2487 2.86043 8.0546 8.05449C2.86054 13.2487 0 20.1545 0 27.5C0 34.8455 2.86054 41.7514 8.0546 46.9455C13.2487 52.1396 20.1545 55 27.5 55C34.8455 55 41.7513 52.1395 46.9455 46.9455C52.1396 41.7514 55 34.8455 55 27.5C55 22.2857 53.5009 17.167 50.7345 12.791Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                    <path d="M22.5225 28.249H32.4768V31.4717H22.5225V28.249Z" fill="#51983C" stroke="#51983C" strokeWidth="0.107422" />
                  </g>
                </g>
                <defs>
                  <clipPath id="clip0_0_1">
              ...
              <div className="service">
                <p className="service-first m-0 p-0">Free Return</p>
                <p className="service-second m-0 p-0 text-center text-md-start">7 days return Policy</p>
              </div>
            </div>
          </div>
        </div>
