...
const { count, increase, decrease } = useStore();
  ...
  const navigateToPage = (pageId) => {
    Object.values(pagesRef.current).forEach((page) => page.classList.remove("active"));
  ...
  const updateActiveStep = (activePageId) => {
    Object.values(stepsRef.current).forEach((step) => step.classList.remove("active"));
  ...
  useEffect(() => {
    // Store page and step elements in refs
    document.querySelectorAll(".page").forEach((page) => (pagesRef.current[page.id] = page));
    document.querySelectorAll(".step").forEach((step) => (stepsRef.current[step.dataset.page] = step));
    ...
    // Setup button events
    document.getElementById("proceed-to-checkout")?.addEventListener("click", () => navigateToPage("checkout-page"));
    ...
    document.getElementById("continue-shopping")?.addEventListener("click", () => navigateToPage("cart-page"));
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-4 col-md-2 text-center">
                      <div className="quantity-selector">
                        <button onClick={decrease} className="quantity-btn decrease">-</button>
                        <input
                          type="text"
                          ...
                          readOnly=""
                        />
                        <button onClick={increase} className="quantity-btn increase">+</button>
                      </div>
                    </div>
