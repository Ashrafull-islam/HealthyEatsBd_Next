...
export default function page() {
    ...
    <div className="row">
      ...
      <div className="col-md-6">
        <div className="product-gallery">
          <div className="side-img d-flex flex-column gap-3 d-none d-lg-block">
            <img
              src="assets/media/product/product.png"
              alt="SideImage"
              decoding="async"
              loading="lazy"
            />
      ...
      <div className="col-md-6 px-4 md:px-0">
        <div aria-label="breadcrumb">
          <ol className="breadcrumb d-flex align-items-center">
            ...
            <li className="breadcrumb-item active d-none d-lg-block">
              Chocolate Peanut Butter_চকলেট পিনাট বাটার
            </li>
        ...
        <div className="product-description my-2">
          <p>
            পরিচয় করিয়ে দিচ্ছি আমাদের ব্যতিক্রমধর্মী পিনাট বাটারের সাথে যা অতি
            ...
            >
              <div className="accordion-body">
                <div className="chocolate-accordion">
                  <h3 className="Chocolate-bold my-2">চকোলেট পিনাট বাটার:</h3>
                  <p className="Chocolate-normal">
                    পরিচয় করিয়ে দিচ্ছি আমাদের ব্যতিক্রমধর্মী পিনাট বাটারের সাথে
                  ...
                  <h3 className="Chocolate-bold">
                    চকোলেট পিনাট বাটারের উপকারিতা:
                  </h3>
                  <ul>
                    <li className="Chocolate-normal">
                      <strong>শক্তি বাড়ায়:</strong> পিনাট বাটারে প্রচুর
                    ...
                    <li className="Chocolate-normal">
                      ...
                      পিনাট বাটার মস্তিষ্কের কার্যক্ষমতা ও স্মৃতিশক্তি বাড়ায়।
                      এছাড়াও এতে রয়েছে ট্রিপটোফেন নামক এমন একটি উপাদান যা আমাদের
                      মুড ভালো রাখে।
                    </li>
                  </ul>
                  <h3 className="Chocolate-bold">
                    চকোলেট পিনাট বাটারের ব্যবহারঃ
                  </h3>
                  <ul>
                    <li className="Chocolate-normal">
  ...
  <section>
    <div className="other-container my-3 d-none d-lg-block my-5">
      <h3 className="product-head my-4">Related products</h3>
      <div className="swiper-card">
        <div className="swiper-container">
          <div className="swiper myCardSwiper">
            <div className="swiper-wrapper ">
              ...
              <div className="swiper-slide">
                <div className="card text-center position-relative">
                  ...
                  <p className="chocolate-p my-1 p-0">
                    Chocolate Peanut Butter- চকলেট পিনাট বাটার
                  </p>
              ...
              <div className="swiper-slide">
                <div className="card text-center position-relative">
                  ...
                  <p className="chocolate-p my-1 p-0">Black Rice – কালো চাল</p>
                  <p className="price text-center mb-2 p-0">
                    ৳&nbsp;200 - ৳&nbsp;520{" "}
                  </p>
                  <div>
              ...
              <div className="swiper-slide">
                <div className="card text-center position-relative">
                  ...
                  <p className="chocolate-p my-1 p-0">Brown Atta – লাল আটা</p>
